                            ...
                            open == 0
                                ...
                                : open == 1
                                    ...
                                    : open == 2
                                        ? "Numbers"
                                        : "Pokemon",
                            style: TextStyle(color: Color(0xffDD2A7B), fontSize: 16.5, fontWeight: FontWeight.bold),
                          ),
                          choose == false
                              ? Icon(
          ...
          body: Stack(
            ...
            children: [
              ...
              AnimatedPositioned(
                ...
                top: numberOfTurns >= 1 ? MediaQuery.of(context).size.height * 0.14 : MediaQuery.of(context).size.height * 0.18,
                        ...
                        child: Card(
                            ...
                            child: Center(
                              child: Padding(
                                ...
                                child: Text("Pokemon", style: TextStyle(fontSize: 18, color: Color(0xffDD2A7B), fontWeight: FontWeight.bold)),
                              ),
                            )),
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Card(
                            ...
                            child: Center(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 8, right: 8),
                                child: Text("Emojis", style: TextStyle(fontSize: 18, color: Color(0xffDD2A7B), fontWeight: FontWeight.bold)),
                              ),
                            )),
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Card(
                            ...
                            child: Center(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 8, right: 8),
                                child: Text("Numbers", style: TextStyle(fontSize: 18, color: Color(0xffDD2A7B), fontWeight: FontWeight.bold)),
                              ),
                            )),
                      ),
                    ),
